...
from ..DTO.Event import EventDTO, BaseEventDTO
...
class Base(Controller):
    class Meta:
        ...
        epilog = 'Usage: pycryptobot --foo bar'
        ...
        if immediate_action is True or _state.last_df_index != current_df_index:
            ...
            if not _app.isVerbose():
                ...
                if not _app.isSimulation() or (
                    ...
                    for res in  _app.cementApp.hook.run('event_log_technical_indicators', _app.cementApp, event):
                        pass
