...
class GuiSetup:
    ...
    def update_textbox(self, txtbox, file, key) -> None:
        ...
        if key in ("margin", "delta") and txtbox.value != "N/A":
            txtbox.bg = "#38BC38" if float(txtbox.value.replace("%", "")) > 0 else "#BC3838"
...
# menu bar
menu = MenuBar(app, toplevel=["Display Options"], options=[[["Background Color", main_bg], ["Text Color", text_clr], ["About", about]]])
