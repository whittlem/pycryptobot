...
def test_get_account(mocker):
    ...
    mocker.patch("models.Binance.Client.get_account", return_value=client_response)
...
def test_get_fees_with_market(mocker):
    ...
    mocker.patch("models.Binance.Client.get_trade_fee", return_value=client_response)
...
def test_get_orders(mocker):
    ...
    exchange = AuthAPI(api_key, api_secret, api_url)
    assert type(exchange) is AuthAPI
    mocker.patch("models.Binance.Client.get_all_orders", return_value=client_response)
