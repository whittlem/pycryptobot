...
class Strategy_CS:
    ...
    def tradeSignals(self, data, _df):
        ...
        # Buys - currently RSI, OBV - add self.pts_sig_required_buy += 1 to each one
        self.sig_required_buy = 2
        # Sells - currently EMA/WMA - self.pts_sig_required_sell += 1
